...
const About1 = () => {
  const whyTummyTalesFeatures = [
    ...
    { 
      ...
      href: "#features",
      iconBgColor: "from-rose-400 to-red-400",
    ...
    { 
      ...
      href: "#calendar",
      iconBgColor: "from-fuchsia-400 to-pink-500",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-100 via-rose-50 to-pink-200 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 left-0 w-96 h-96 bg-gradient-to-br from-pink-300/20 to-rose-400/20 rounded-full blur-3xl opacity-70"></div>
        <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-gradient-to-tl from-pink-300/30 to-rose-500/30 rounded-full blur-2xl opacity-70"></div>
        <div className="absolute top-1/3 right-1/4 w-64 h-64 bg-gradient-to-r from-rose-200/25 to-pink-300/25 rounded-full blur-xl opacity-70"></div>
      </div>
      ...
      <section className="py-20 text-center relative z-10">
        <div className="container mx-auto px-4">
          <h1 className="text-5xl md:text-6xl font-bold text-gray-800 mb-6">
            <span className="inline-block animate-bounce bg-gradient-to-r from-pink-500 to-rose-500 bg-clip-text text-transparent">
      ...
      <div className="container mx-auto py-8 px-4 relative z-10">
        <div className="bg-gradient-to-r from-white/70 via-pink-50/70 to-rose-50/70 backdrop-blur-md rounded-3xl p-6 md:p-8 mb-12 shadow-lg">
          <HeroSection />
        </div>
        
        {/* How It Works Section */}
        <div className="bg-gradient-to-l from-rose-100/80 to-pink-100/80 backdrop-blur-md rounded-3xl p-6 md:p-8 mb-12 shadow-lg">
          <div className="text-center mb-12">
            <div className="inline-flex items-center space-x-3 bg-white/80 backdrop-blur-sm px-6 py-3 rounded-full shadow-md mb-6">
              ...
              <span className="text-pink-600 font-semibold">Simple Process</span>
            </div>
          ...
          <div className="max-w-3xl mx-auto space-y-8">
            {[
              { step: "01", icon: Download, title: "Download App", desc: "Download TummyTales from App Store or Google Play Store and install it on your device.", color: "from-pink-400 to-rose-400" },
              { step: "02", icon: UserPlus, title: "Create Profile", desc: "Set up your pregnancy profile with due date, preferences, and personal information.", color: "from-rose-400 to-pink-400" },
              { step: "03", icon: Heart, title: "Get Personalized Care", desc: "Receive AI-powered guidance, tips, and support tailored to your pregnancy stage.", color: "from-pink-400 to-rose-400" },
              { step: "04", icon: Users, title: "Join Community", desc: "Connect with other expecting mothers and share your beautiful pregnancy journey.", color: "from-rose-400 to-pink-400" }
            ].map((step, index) => (
                ...
                <CardContent className="p-6 md:p-8 relative">
                  <div className="flex flex-col sm:flex-row items-center sm:space-x-6">
                    ...
                    <div className="flex-1 text-center sm:text-left">
                      <h3 className="text-2xl font-bold text-gray-800 mb-3 group-hover:text-rose-600 transition-colors duration-300">{step.title}</h3>
          ...
          <div className="text-center mt-12">
            <Button size="lg" className="bg-gradient-to-r from-pink-500 to-rose-500 hover:from-pink-600 hover:to-rose-600 text-white rounded-xl px-10 py-7 text-lg shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
        ...
        <div className="bg-gradient-to-r from-pink-50/80 to-rose-50/80 backdrop-blur-md rounded-3xl p-6 md:p-8 mb-12 shadow-lg">
          <div className="text-center mb-12">
            <div className="inline-flex items-center space-x-3 bg-white/80 backdrop-blur-sm px-6 py-3 rounded-full shadow-md mb-6">
              <Sparkles className="h-6 w-6 text-rose-500" />
              <span className="text-pink-600 font-semibold">Why TummyTales?</span>
            </div>
              ...
              <a key={index} href={feature.href} className="block group">
                <Card className="bg-white/90 backdrop-blur-md hover:bg-white transition-all duration-300 border-0 hover:shadow-xl transform hover:-translate-y-2 hover:scale-105 rounded-2xl overflow-hidden text-center cursor-pointer h-full flex flex-col">
                  <CardContent className="p-6 flex flex-col items-center justify-center flex-grow relative">
                    ...
                    <h3 className="text-lg md:text-xl font-semibold text-gray-800 group-hover:text-rose-600 transition-colors duration-300 mb-1">
                      {feature.title}
                    </h3>
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-rose-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-2xl"></div>
                  </CardContent>
                </Card>
              </a>
            ))}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div id="features" className="bg-gradient-to-l from-rose-100/80 to-pink-100/80 backdrop-blur-md rounded-3xl p-6 md:p-8 mb-12 shadow-lg">
          <FeaturesSection />
        </div>
        
        <div id="calendar" className="bg-gradient-to-r from-pink-200/60 to-rose-200/60 backdrop-blur-md rounded-3xl p-6 md:p-8 mb-12 shadow-lg">
          <CalendarSection />
        </div>
        
        <div id="community" className="bg-gradient-to-l from-rose-50/90 to-pink-50/90 backdrop-blur-md rounded-3xl p-6 md:p-8 mb-12 shadow-lg">
          <CommunitySection />
        </div>
        
        <div id="nutrition-baby" className="bg-gradient-to-r from-pink-100/70 to-rose-100/70 backdrop-blur-md rounded-3xl p-6 md:p-8 mb-12 shadow-lg">
          <NutritionBabySection />
        </div>
        
        <div id="trust-security" className="bg-gradient-to-l from-rose-200/50 to-pink-200/50 backdrop-blur-md rounded-3xl p-6 md:p-8 mb-12 shadow-lg">
          <TrustSecuritySection />
        </div>
        
        <div className="bg-gradient-to-r from-pink-300/40 to-rose-300/40 backdrop-blur-md rounded-3xl p-6 md:p-8 shadow-lg">
          <CTASection />
        </div>
      </div>
    </div>
